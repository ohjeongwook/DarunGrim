...
dgf_analyzer=DGFAnalyzer(sys.argv[1])
FullMatchedBlocksCount=dgf_analyzer.GetFullMatchedBlocksCount()
MatchMapCount=dgf_analyzer.GetMatchMapCount()
UnidentifiedBlocksCount_1=dgf_analyzer.GetUnidentifiedBlocksCount(1)
UnidentifiedBlocksCount_2=dgf_analyzer.GetUnidentifiedBlocksCount(2)

WholeBlocksCount=dgf_analyzer.GetOneLocationInfoCount(1)+dgf_analyzer.GetOneLocationInfoCount(2)
