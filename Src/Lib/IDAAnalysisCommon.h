...
enum { ONE_LOCATION_INFO,MAP_INFO,FILE_INFO,END_OF_DATA, DISASM_LINES, INPUT_NAME};
...
#define CREATE_ONE_LOCATION_INFO_TABLE_FUNCTION_ADDRESS_INDEX_STATEMENT "CREATE INDEX "ONE_LOCATION_INFO_TABLE"FunctionAddressIndex ON "ONE_LOCATION_INFO_TABLE" (FunctionAddress)"
